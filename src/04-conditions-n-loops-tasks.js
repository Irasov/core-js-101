...
function doRectanglesOverlap(rect1, rect2) {
  const rr1 = rect1.left + rect1.width;
  const rb1 = rect1.top + rect1.height;
  const rr2 = rect2.left + rect2.width;
  const rb2 = rect2.top + rect2.height;
  return rect1.left < rr2 && rr1 > rect2.left
  && rect1.top < rb2 && rb1 > rect2.top;
}
